...
class firstSetup:
    ...
    def next_setup(self):
        ...
        try:
            ...
            if rows > 10:
                rows = MAX_ROWS
                print("ROW INPUT HAS BEEN ADJUSTED TO 10")
            if rows < 1:
                rows = MIN_ROWS
                print("ROW INPUT HAS BEEN ADJUSTED TO 1")
            if cols > 10:
                cols = MAX_COLUMNS
                print("COLUMN INPUT HAS BEEN ADJUSTED TO 10")
            if cols < 1:
                cols = MIN_COLUMNS
                print("COLUMN INPUT HAS BEEN ADJUSTED TO 1")
...
"""
a## Go around block. Wait aside for agent1 to pass
